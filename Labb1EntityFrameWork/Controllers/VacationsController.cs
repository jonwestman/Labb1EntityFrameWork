...
namespace Labb1EntityFrameWork.Controllers
{
    public class VacationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VacationId,StartDate,EndDate,VacayType,DateApplied")] Vacation vacation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VacationId,StartDate,EndDate,VacayType,DateApplied")] Vacation vacation)
        {
